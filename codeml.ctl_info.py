...
outfile = output.mlc      	#main result file name

noisy = 3  		* 0,1,2,3,9: how much rubbish on the screen
verbose = 1  	* 0: concise; 1: detailed, 2: too much #display on screen?
runmode = 0  	* 0: user tree;  1: semi-automatic;  2: automatic
				* 3: StepwiseAddition; (4,5):PerturbationNNI; -2: pairwise

seqtype = 2  	* 1:codons; 2:AAs; 3:codons-->AAs
CodonFreq = 2  	* 0:1/61 each (equal), 1:F1X4, 2:F3X4, 3:codon table
...
fix_omega = 0  	* 1: omega or omega_1 fixed, 0: estimate omega
...
Malpha = 0  	* different alphas for genes
			...
			#set ncatG for models M3, M7, M8
*ncatG = 3  	* # of site categories in M3 of NSsites models in Table 4
